...
from models.sctanet import SCTANet

class SCTANetModel(BaseModel):

    def modify_commandline_options(parser, is_train):
        parser.add_argument('--scale_factor', type=int, default=8, help='upscale factor for sctanet')
    ...
    def __init__(self, opt):
        ...
        self.netG = SCTANet(scale = opt.scale_factor) 

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        #parser.add_argument('--dataroot', type=str, default='/media/h205b/DATA1/bqq/A_DATASET/FACE_DATASET/CelebA/img_align_celeba', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--nfeat', type=int, default=60)

        parser.add_argument('--relu_type', type=str, default='leakyrelu')

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='sctanet', help='chooses which model to train [parse|enhance]')
        parser.add_argument('--res_depth', type=int, default=1, help='depth of residual layers')

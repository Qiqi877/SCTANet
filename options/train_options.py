...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot_train', type=str, default='/media/h205b/DATA1/bqq/A_DATASET/FACE_DATASET/CelebA/img_align_celeba')
        parser.add_argument('--dataroot_test', type=str, default='/media/h205b/DATA1/bqq/A_DATASET/FACE_DATASET/CelebA/img_align_celeba')
        parser.add_argument('--save_as_dir_test', type=str, default='./eval_results')
        parser.add_argument('--eval_psnr_ssim', type=str, default='./eval_results.txt')
        ...
        parser.add_argument('--test_img_freq', type=int, default=1, help='epoch of testing the images')
